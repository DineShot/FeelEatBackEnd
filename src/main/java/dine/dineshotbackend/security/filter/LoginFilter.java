package dine.dineshotbackend.security.filter;
...
public class LoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(accountId,token,null);
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        Long accountCode = customUserDetails.getAccountCode();

        String token = jwtUtil.createJwt(accountId, accountRole,accountCode, 60*60*60*10L);
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response, AuthenticationException failed) throws IOException, ServletException {
        ...
        String userCode = request.getHeader("userId");
        System.out.println("userCodejfwklfjkwjfwl = " + userCode);
        response.setHeader("userCode",userCode);
